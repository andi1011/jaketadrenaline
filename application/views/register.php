        ...
        <div class="login-box">
            ...
            <h3 class="text-center title-login">Registrasi</h3>
				...
				<h5>Jenis Kelamin : </h5><?php echo form_error('jenis_k') ?>
                    <input type="radio"  name="jenis_k" value="Laki-laki"> Laki-laki
                ...
                <div class="form-group">
                <?php echo form_error('alamat') ?><input type="text" class="form-control" name="alamat" placeholder="Alamat">
                </div>
                ...
                <div class="form-group">
                <?php echo form_error('username') ?><input type="text" class="form-control" name="username" placeholder="Username">
                </div>
				...
				<?php echo form_error('role') ?>
                    <input type="radio"  name="role" value="Pemesan"><label for="Pemesan"> Check Please</label>
                </div>
                ...
                <div class="pull-right">
                    <p><a href="<?php echo base_url('auth2'); ?>" class="btn btn-danger">Back</a></p>
                </div>
                </form>
